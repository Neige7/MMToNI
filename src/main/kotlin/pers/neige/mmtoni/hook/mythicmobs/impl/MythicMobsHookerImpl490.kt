...
class MythicMobsHookerImpl490 : MythicMobsHooker() {
    ...
    override fun editMythicItem() {
        ...
        try {
            ...
            generateItemStack = ctClass.getDeclaredMethod("generateItemStack", arrayOf(pool.get("io.lumine.xikage.mythicmobs.drops.DropMetadata"), CtClass.intType))
            generateItemStack.setBody("{org.bukkit.inventory.ItemStack itemStack = pers.neige.neigeitems.manager.ItemManager.INSTANCE.getItemStack(this.internalName);itemStack.setAmount($2);return new io.lumine.xikage.mythicmobs.adapters.bukkit.BukkitItemStack(itemStack);}")
